...
//(1)초기값: let index = numbers =numbers.length -1 //(2) 조건문: index>=0;
...
for(let i = 0; i<=scores.length - 1;i++){
    ...
    console.log(`점수 합계는 ${sum}이고 평균은 ${avg}이다.`);
}
}
...
let scores = [77, 82, 100, 54, 96];
for(let score=0;  scores<=cores.length-1,i++){
    if(score )
}
